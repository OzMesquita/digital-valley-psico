        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control" id="" :class="{'is-invalid' : errors.has('id_cidade')}"  name="id_cidade" v-model="id_cidade" v-validate="'required'">
                        ...
                        <option v-for="cidade in cidades" :key='cidade.id' :value=cidade.id>{{cidade.name}}</option>
                    </select>
            ...
            <div class="col col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" :class="{'is-invalid' : errors.has('endereco')}"  name="endereco" id="endereco" placeholder="Digite seu endereço" v-model="endereco" maxlength="63" v-validate="'required|min:5'"/>
        ...
        <div class="row">
            <div class="col col-12">
                ...
                <div class="fa-pull-right">
                    <button type="button" class="btn mybtn-table" :disabled="!this.isValid()"  @click="this.proximo" >Próximo <i class="fas fa-chevron-right"></i></button>
                </div>
            </div>
        </div>
    </div>
