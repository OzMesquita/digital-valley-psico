  ...
  <div>
      ...
      <div class="col col-12">
        <div class="form-group">
          ...
          <input
            type="hidden"
            class="form-control"
            :class="{'is-invalid' : errors.has('nome'), 'is-valid': this.validaNome()}"
            id="nome"
    ...
    <div class="row">
      <div class="col col-3">
        ...
        <div
          class="form-group"
          :class="{'is-invalid' : errors.has('genero'), 'is-valid': this.validaGenero()}"
        >
...
export default {
  ...
  mounted() {
    ...
    var hoje = new Date();
    this.open_date = Moment(hoje.getTime() - 365 * 15 * dia).format(
      "YYYY-MM-DD"
    );
